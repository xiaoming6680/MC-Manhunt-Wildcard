...
public class SneakFreezeRule implements WildcardRule {
    ...
    private void freeze(ServerPlayerEntity player) {
        ...
        addLock(player, EntityAttributes.GENERIC_MOVEMENT_SPEED);
        addLock(player, EntityAttributes.GENERIC_JUMP_STRENGTH);
    ...
    private void thaw(ServerPlayerEntity player) {
        ...
        removeLock(player, EntityAttributes.GENERIC_MOVEMENT_SPEED);
        removeLock(player, EntityAttributes.GENERIC_JUMP_STRENGTH);
