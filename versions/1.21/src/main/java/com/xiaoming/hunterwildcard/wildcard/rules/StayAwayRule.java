...
public class StayAwayRule implements WildcardRule {
    ...
    public static boolean isStayAwaySword(ItemStack stack) {
        ...
        return data != null && data.copyNbt().getBoolean(DATA_KEY);
    }
    ...
    private static ItemStack createSword(MinecraftServer server) {
        ...
        Registry<Enchantment> enchantments = server.getRegistryManager().get(RegistryKeys.ENCHANTMENT);
        RegistryEntry<Enchantment> sharpness = enchantments.entryOf(Enchantments.SHARPNESS);
