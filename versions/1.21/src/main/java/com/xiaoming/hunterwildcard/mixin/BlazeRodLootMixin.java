...
public class BlazeRodLootMixin {
    ...
    private void hunterwildcard$blazeRodChance(LootTable table, LootContextParameterSet parameters, long seed, Consumer<ItemStack> consumer, Operation<Void> original, DamageSource source, boolean causedByPlayer) {
        ...
        if (!((Object) this instanceof BlazeEntity blaze) || !causedByPlayer || !config.blazeRodChanceEnabled
                || !blaze.getLootTable().getValue().equals(Identifier.ofVanilla("entities/blaze"))) {
