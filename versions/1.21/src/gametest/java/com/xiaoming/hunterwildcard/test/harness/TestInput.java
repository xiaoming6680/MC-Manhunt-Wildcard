...
public final class TestInput {
    ...
    static void invoke(Object target,String name,Class<?>[] types,Object...args){try{var method=target.getClass().getDeclaredMethod(name,types);method.setAccessible(true);method.invoke(target,args);}catch(Exception e){throw new AssertionError("Native input/world action "+name,e);}}
