...
public final class TestSingleplayerContext implements AutoCloseable {
    ...
    @Override public void close(){context.runOnClient(c->{c.world.disconnect();c.disconnect(new TitleScreen(),false);c.setScreen(new TitleScreen());});context.waitFor(c->c.getServer()==null,1200);context.waitTicks(5);}
}