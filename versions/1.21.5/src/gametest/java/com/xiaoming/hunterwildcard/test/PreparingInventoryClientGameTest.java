            ...
            for (PlayerRole role : PlayerRole.values()) {
                for (boolean keep : new boolean[]{true, false}) {
                    ...
                    world.getServer().runOnServer(server -> {
                        ...
                        var drops = player.getServerWorld().getEntitiesByClass(ItemEntity.class,
                        ...
                        player.getServerWorld().getEntitiesByClass(ItemEntity.class, player.getBoundingBox().expand(5), e -> true)
