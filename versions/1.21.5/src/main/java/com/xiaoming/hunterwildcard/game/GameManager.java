...
public class GameManager {
    ...
    private void launchWinnerFireworks(GameContext context, WinningSide winningSide) {
        ...
        for (ServerPlayerEntity winner : winners) {
            ServerWorld world = winner.getServerWorld();
            for (int i = 0; i < 2; i++) {
    ...
    private void applyLocatorBarForRound(MinecraftServer targetServer) { /* Vanilla locator bar is absent before 1.21.6. */ }
    ...
    private void restoreLocatorBarRule(MinecraftServer targetServer) { /* Vanilla locator bar is absent before 1.21.6. */ }
