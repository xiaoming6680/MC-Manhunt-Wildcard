...
public class WildcardDrawOverlay {
    ...
    public static void register() {
        HudRenderCallback.EVENT.register(WildcardDrawOverlay::render
        );
    }
    ...
    public static void start(String wildcardName) {
        ...
        MinecraftClient.getInstance().getSoundManager().play(PositionedSoundInstance.master(SoundEvents.UI_BUTTON_CLICK, 1.2F));
    }
    ...
    private static void render(DrawContext context, RenderTickCounter tickCounter) {
        ...
        context.getMatrices().scale(HudLayout.scale(),HudLayout.scale(),1);
        introPanelBottom = 0;
