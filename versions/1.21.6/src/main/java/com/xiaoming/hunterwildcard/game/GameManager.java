...
public class GameManager {
    ...
    private List<HunterWildcardPackets.MemberEntry> roster(ServerPlayerEntity viewer) {
        ...
        MinecraftServer rosterServer = viewer == null ? server : viewer.getWorld().getServer();
    ...
    private GameContext wildcardEventContext(ServerPlayerEntity player) {
        ...
        MinecraftServer targetServer = player.getWorld().getServer();
        if (targetServer == null) {
            return null;
        }
    ...
    private void applyLocatorBarForRound(MinecraftServer targetServer) {
        ...
        if (previousLocatorBarRule == null) {
            previousLocatorBarRule = targetServer.getOverworld().getGameRules().getBoolean(GameRules.LOCATOR_BAR);
        }
        targetServer.getOverworld().getGameRules().get(GameRules.LOCATOR_BAR).set(config.locatorBarTeamOnly, targetServer);
    }
    ...
    private void takeOverKeepInventory(MinecraftServer targetServer) {
        ...
        if (previousKeepInventoryRule == null) {
            previousKeepInventoryRule = targetServer.getOverworld().getGameRules().getBoolean(GameRules.KEEP_INVENTORY);
        }
    ...
    private void enforceKeepInventory(MinecraftServer targetServer) {
        ...
        if (Boolean.TRUE.equals(targetServer.getOverworld().getGameRules().getBoolean(GameRules.KEEP_INVENTORY))) {
            targetServer.getOverworld().getGameRules().get(GameRules.KEEP_INVENTORY).set(false, targetServer);
        }
    }
    ...
    private void restoreKeepInventory(MinecraftServer targetServer) {
        ...
        targetServer.getOverworld().getGameRules().get(GameRules.KEEP_INVENTORY).set(previousKeepInventoryRule, targetServer);
        previousKeepInventoryRule = null;
    }
    ...
    private void restoreLocatorBarRule(MinecraftServer targetServer) {
        ...
        targetServer.getOverworld().getGameRules().get(GameRules.LOCATOR_BAR).set(previousLocatorBarRule, targetServer);
    }
