...
public final class TiltFrame {
    ...
    public static BlockPos support(Entity entity) {
        return supportingBlock(entity).orElseGet(()->BlockPos.ofFloored(entity.getEntityPos().add(down(entity).multiply(.05))));
    }
    public static java.util.Optional<BlockPos> supportingBlock(Entity entity) {
        double half=entity.getWidth()/2.0;
        Box feet=rotateBox(direction(entity),new Box(-half,-1.0E-6,-half,half,0,half),false).offset(entity.getEntityPos());
    ...
    public static Vec3d collide(Entity entity, Vec3d movement) {
        ...
        Vec3d origin=entity.getEntityPos();
