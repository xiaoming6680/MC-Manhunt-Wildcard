...
public final class RuleFields {
    ...
    public static boolean validItem(String raw) {
        net.minecraft.util.Identifier id = net.minecraft.util.Identifier.tryParse(raw.trim());
        return id != null && net.minecraft.registry.Registries.ITEM.containsId(id) && !id.toString().equals("minecraft:air");
    }
