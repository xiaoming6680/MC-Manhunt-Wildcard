...
final class UiRedesignAssertions {
    ...
    static void run(ClientGameTestContext c,TestSingleplayerContext world){
        ...
        c.runOnClient(client->{
            ...
            screen(client).keyPressed(new KeyInput(256,0,0));
            ...
            offButtons.get(1).onPress(new KeyInput(257,0,0));
        ...
        c.runOnClient(client->{
            ...
            d.setFocused(true);d.keyPressed(new KeyInput(257,0,0));d.keyPressed(new KeyInput(264,0,0));d.keyPressed(new KeyInput(257,0,0));check(selected.get().equals("b"),"Dropdown supports keyboard selection");
        });
        c.runOnClient(client->{
